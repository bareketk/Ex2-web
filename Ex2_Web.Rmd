...
In addition,  to check if the investment is worthwhile, i.e, checking if the borrower is worth investing in. finally, investigate if there is a connection between to of the above.  
